...
func main() {
	...
	fmt.Println(frequency) // map[1:14 4:9 9:11 5:8 2:10 3:7 7:15 6:10 8:7 10:9]
	fmt.Println(uniques)   // [10 5 2 3 7 1 4 9 6 8]  --- in the order in which they occur in nums
}
